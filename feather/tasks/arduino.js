...
function initTasks(gulp, options) {
  ...
  gulp.task('verify', 'Builds the app', ['gen-key'], function(cb) {
      all.localExecCmd(getArduinoCommand() + ' --verify --board ' + boardDescriptor +
        process.cwd() + '/app/app.ino --verbose-build', args.verbose, cb);
  });
